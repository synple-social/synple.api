...
import { MailerService, MailPayload, PreRegistration, PreRegistrationsService } from '@synple/common';
...
describe('Pre registrations scenarios', () => {
  ...
  beforeAll(async () => {
    app = await createApplication({ overrides: [{ from: MailerService, to: MockMailerService }] })
  });
