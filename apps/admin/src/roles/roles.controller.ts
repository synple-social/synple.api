...
export class RolesController {
  ...
  @ApiCreatedResponse({
    description:
      'The scope has been correctly added to the role. When a role has a scope, all users having this role are considered able to use it.',
  ...
  @ApiNoContentResponse({
    description:
      'The scope and the role are no longer linked, users having this role are considered not having this scope anymore.',
  })
  @ApiNotFoundResponse({
    description:
      'Either the role or the scope have not been found in the database. Please check scopeId and uuid for typos.',
