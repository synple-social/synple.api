...
@Module({
  ...
  providers: [RolesService, UuidsService, JwtService, TokensService, AccountsService, RegistrationsService, PreRegistrationsService, MailerService, ConfirmationCodesService],
})
